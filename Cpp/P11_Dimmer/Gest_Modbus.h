...
#define ADDR_ACTDIM1		12		//Activa/Desactiva Dimmer 1
#define ADDR_ACTDIM2		13		//Activa/Desactiva Dimmer 2
#define ADDR_POT1DIM1   	14		//Activa/Desactiva POT 1 to DIM 1
#define ADDR_POT2DIM2   	15		//Activa/Desactiva POT 2 to DIM 2
