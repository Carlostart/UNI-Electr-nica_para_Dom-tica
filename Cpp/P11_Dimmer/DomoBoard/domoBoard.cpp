...
const char NAME_DIMMER1[]	PROGMEM = {"Dimmer 1"};
const char NAME_DIMMER2[] 	PROGMEM = {"Dimmer 2"};
...
DomoBoard::DomoBoard()
{
	...
	//==========================
	//Inicialización DIMMERS
	//==========================
	DIMMER1.Enabled 			= true;
	DIMMER1.pin 				= DIMMER1_P;
	DIMMER1.name 				= NAME_DIMMER1;
	pinMode(DIMMER1_P, OUTPUT);

	DIMMER2.Enabled 			= true;
	DIMMER2.pin 				= DIMMER2_P;
	DIMMER2.name 				= NAME_DIMMER2;
 ...
 *
 * · Desactivamos salida
 * · Indicamos que el pulso del dimmer está activo
 * · iniciamos el tiempo de retraso para activar para activar dimmer
 */
void	DomoBoard::IniciaDimmer(TDimmer *dimmer){
	digitalWrite(dimmer->pin, LOW);
	dimmer->Pulse_Act				= false;
	dimmer->delay_timmer 			= 0;
}
