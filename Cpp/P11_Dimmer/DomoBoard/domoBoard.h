...
typedef struct
{
	bool	  	Enabled;				//Habilita Dimmer
	byte	  	pin;					//Pin control Dimmer
	uint16_t	delay_timmer;			//BaseTiempo Dimmer
	uint16_t    val_act;				//Valor activación % con el que se activa l TRIAC
	bool		Pulse_Act;				//Pulso activación TRIAC Activo
	char		*name;
}TDimmer, *TDimmerPtr;
...
/***        Macro Definitions                                             ***/
/****************************************************************************/
#define		PZERO_P					2			// Detector de Fase. Pin Paso por zero
...
#define     DIMMER1_P           	8           // Pin Control Dimmer 1
#define     DIMMER2_P           	9           // Pin Control Dimmer 2
...
public:
	...
	void			IniciaDimmer(TDimmer *dimmer);
