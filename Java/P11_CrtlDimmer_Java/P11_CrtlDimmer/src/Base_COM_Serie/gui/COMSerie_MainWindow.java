...
//		String[] portNames = SerialPortList.getPortNames();
		...
		JMenu mnNewMenu_3 = new JMenu("Pr\u00E1ctica 9 - Sensores Anal\u00F3gicos (All)");
		...
		JMenu mnNewMenu_4 = new JMenu("Pr\u00E1ctica 10 - Control Persianas");
		...
		JMenu mnNewMenu_4_1 = new JMenu("Pr\u00E1ctica 11- Dimmer");
		mnSeleccionarPrctica.add(mnNewMenu_4_1);
		
		JRadioButtonMenuItem P11_1_Dimmer = new JRadioButtonMenuItem("Dimmer");
		P11_1_Dimmer.addActionListener(Select_Practica);
		mnNewMenu_4_1.add(P11_1_Dimmer);
		
		JRadioButtonMenuItem P11_2_IlumConst = new JRadioButtonMenuItem("Iluminaci\u00F3n Constante");
		P11_2_IlumConst.addActionListener(Select_Practica);
		mnNewMenu_4_1.add(P11_2_IlumConst);
		...
		practicaSel.add(P11_1_Dimmer);
		practicaSel.add(P11_2_IlumConst);
