...
public class MB_Registers {
	...
	public static final int SELPRACT[] = {0x11, 0x12, 0x13, 0x32, 0x41, 0x42, 0x43, 0x54, 0x62, 0x70, 0x90, 0xA1, 0xA2, 0xB1, 0xB2};
/*	
...
*/	
	...
	public enum MB_Analog_Output_Holding {
		...
		MB_DIMMER1(6),			// Dimmer 1
		MB_DIMMER2(7),         	// Dimmer 2
		MB_AREGS(8);
	...
	public enum MB_Discrete_Output_Coils {
		...
		MB_ACTDIM1(8),					//Salida virtual para Activar/Desactivar Dimmer 1
		MB_ACTDIM2(9),					//Salida virtual para Activar/Desactivar Dimmer 2
		MB_POT1DIM1(10),				//Salida virtual para Activar/Desactivar Pot 1 como controlador Dim 1
		MB_POT2DIM2(11),				//Salida virtual para Activar/Desactivar Pot 2 como controlador Dim 2
		MB_O_COILS(12);
