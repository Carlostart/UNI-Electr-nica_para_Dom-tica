...
public class DomoBoardGui extends JPanel implements Visualizer {
	...
	private 		JCheckBox 			ActivarDimmer_2;
	private			JCheckBox 			ActivarDimmer_1;
	private			JSlider 			slider_Dim1;
	private 		JSlider 			slider_Dim2;
	private			JCheckBox 			ActivaPot_1;
	private 		JCheckBox 			ActivaPot_2;
	
	private			boolean				Slider1MousePressed	= false;
	private			boolean				Slider2MousePressed	= false;
	...
	public DomoBoardGui(String category, String address, CommTransport sn_Transport) {
		...
		panel_4.setBounds(460, 280, 338, 271);
		add(panel_4);
		...
		panel_5.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(0, 0, 255), new Color(0, 255, 0), Color.BLUE, Color.MAGENTA));
		panel_5.setBounds(10, 418, 406, 213);
		add(panel_5);
		
		JLabel lblCtrlDimers = new JLabel("CTRL. Dimers");
		lblCtrlDimers.setHorizontalAlignment(SwingConstants.CENTER);
		lblCtrlDimers.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblCtrlDimers.setBounds(10, 178, 390, 24);
		panel_5.add(lblCtrlDimers);
		
		slider_Dim1 = new JSlider();
		slider_Dim1.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				Slider1MousePressed = true;
        		//actionPerformed(new ActionEvent(this, STOPTIMER, "Slider Mouse Pressed"));
			}
			
			@Override
        	public void mouseReleased(MouseEvent e) {
        		Slider1MousePressed = false;
        		
        		//actionPerformed(new ActionEvent(this, STARTIMER, "Slider Mouse Released"));        		        		
        	}
		});
		slider_Dim1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				if(Slider1MousePressed & !ActivaPot_1.isSelected() & ActivarDimmer_1.isSelected()){
        			String vSel = String.valueOf(100 - slider_Dim1.getValue());
    				String vReg = String.valueOf(MB_Registers.MB_Analog_Output_Holding.MB_DIMMER1.getReg());
		...
		slider_Dim1.setPaintTicks(true);
		slider_Dim1.setPaintLabels(true);
		slider_Dim1.setMinorTickSpacing(5);
		slider_Dim1.setMajorTickSpacing(10);
		slider_Dim1.setForeground(Color.BLUE);
		slider_Dim1.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		slider_Dim1.setBackground(SystemColor.menu);
		slider_Dim1.setBounds(10, 11, 262, 68);
		panel_5.add(slider_Dim1);
		
		slider_Dim2 = new JSlider();
		slider_Dim2.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				Slider2MousePressed = true;
        		//actionPerformed(new ActionEvent(this, STOPTIMER, "Slider Mouse Pressed"));
			}
			
			@Override
        	public void mouseReleased(MouseEvent e) {
        		Slider2MousePressed = false;
        		
        		//actionPerformed(new ActionEvent(this, STARTIMER, "Slider Mouse Released"));        		        		
        	}
		});
		slider_Dim2.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				if(Slider2MousePressed & !ActivaPot_2.isSelected() & ActivarDimmer_2.isSelected()){
        			String vSel = String.valueOf(100 - slider_Dim2.getValue());
    				String vReg = String.valueOf(MB_Registers.MB_Analog_Output_Holding.MB_DIMMER2.getReg());
		...
		slider_Dim2.setPaintTicks(true);
		slider_Dim2.setPaintLabels(true);
		slider_Dim2.setMinorTickSpacing(5);
		slider_Dim2.setMajorTickSpacing(10);
		slider_Dim2.setForeground(Color.BLUE);
		slider_Dim2.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		slider_Dim2.setBackground(SystemColor.menu);
		slider_Dim2.setBounds(10, 87, 262, 68);
		panel_5.add(slider_Dim2);
		
		ActivarDimmer_2 = new JCheckBox("Act. Dimmer 2");
		ActivarDimmer_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String vSel;
				String vReg = String.valueOf(MB_Registers.MB_Discrete_Output_Coils.MB_ACTDIM2.getReg());
		...
		ActivarDimmer_2.setBounds(278, 87, 122, 23);
		panel_5.add(ActivarDimmer_2);
		
		ActivaPot_1 = new JCheckBox("Activa Pot. 1");
		ActivaPot_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String vSel;
				String vReg = String.valueOf(MB_Registers.MB_Discrete_Output_Coils.MB_POT1DIM1.getReg());
		...
		ActivaPot_1.setSelected(true);
		ActivaPot_1.setBounds(278, 37, 122, 23);
		panel_5.add(ActivaPot_1);
		
		ActivaPot_2 = new JCheckBox("Activa Pot. 2");
		ActivaPot_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String vSel;
				String vReg = String.valueOf(MB_Registers.MB_Discrete_Output_Coils.MB_POT2DIM2.getReg());
		...
		ActivaPot_2.setSelected(true);
		ActivaPot_2.setBounds(278, 113, 122, 23);
		panel_5.add(ActivaPot_2);
		
		ActivarDimmer_1 = new JCheckBox("Act. Dimmer 1");
		ActivarDimmer_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		
				String vSel;
				String vReg = String.valueOf(MB_Registers.MB_Discrete_Output_Coils.MB_ACTDIM1.getReg());
		...
		ActivarDimmer_1.setBounds(278, 11, 122, 23);
		panel_5.add(ActivarDimmer_1);
	...
	public void UpdateElements(final ModBusEvent e){
		...
		case Const_Modbus.READ_MULTIPLE_REGISTERS:
			...
			for(int i = addr;i<(addr+nReg); i++){
				...
				case MB_DIMMER1:
					slider_Dim1.setValue(100 - e.getRegs()[i-addr]);
					break;
				
				case MB_DIMMER2:
					slider_Dim2.setValue(100 - e.getRegs()[i-addr]);
					break;
		...
		case Const_Modbus.READ_COILS:
			...
			for(int i = addr;i<(addr+nReg); i++){
				...
				case MB_ACTDIM1:
					ActivarDimmer_1.setSelected((e.getRegs()[i] == 1));
					break;
					
				case MB_ACTDIM2:
					ActivarDimmer_2.setSelected((e.getRegs()[i] == 1));
					break;
					
				case MB_POT1DIM1:
					ActivaPot_1.setSelected((e.getRegs()[i] == 1));
					break;
					
				case MB_POT2DIM2:
					ActivaPot_2.setSelected((e.getRegs()[i] == 1));
					break;
